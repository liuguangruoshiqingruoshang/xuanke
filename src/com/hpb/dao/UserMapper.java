...
public interface UserMapper {
	...
	public LaoShi user_log1(@Param("loginname")String loginname,@Param("loginpw")String loginpw);//老师登录
	public XueSheng user_log2(@Param("loginname")String loginname,@Param("loginpw")String loginpw);//学生登录
